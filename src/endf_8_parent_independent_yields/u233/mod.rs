...
use crate::endf_8_parent_independent_yields::u233::fast_energy::u233_fast_fission_yield;
use crate::endf_8_parent_independent_yields::u233::high_energy::u233_high_fission_yield;
use crate::endf_8_parent_independent_yields::u233::thermal_energy::u233_thermal_fission_yield;


pub (crate) fn linear_linear_energy_interpolation_u233(
    ...
    if neutron_energy == thermal_neutron_energy {
        ...
        return u233_thermal_fission_yield(fission_product_nuclide);

    } else if neutron_energy == fast_neutron_energy {
        // fast energy case
        return u233_fast_fission_yield(fission_product_nuclide);

    } else if neutron_energy == high_neutron_energy {
        // high energy case
        return u233_high_fission_yield(fission_product_nuclide);
    ...
    let high_fission_yield = u233_high_fission_yield(
        fission_product_nuclide);
