...
/// 0.0253 eV
///
/// for u238, here is no yield for anything here
///
...
use crate::endf_8_parent_independent_yields::u238::fast_energy::u238_fast_fission_yield;
use crate::endf_8_parent_independent_yields::u238::high_energy::u238_high_fission_yield;
use crate::endf_8_parent_independent_yields::u238::thermal_energy::u238_thermal_fission_yield;


pub (crate) fn linear_linear_energy_interpolation_u238(
    ...
    if neutron_energy == thermal_neutron_energy {
        ...
        return u238_thermal_fission_yield(fission_product_nuclide);

    } else if neutron_energy == fast_neutron_energy {
        // fast energy case
        return u238_fast_fission_yield(fission_product_nuclide);

    } else if neutron_energy == high_neutron_energy {
        // high energy case
        return u238_high_fission_yield(fission_product_nuclide);
    ...
    let high_fission_yield = u238_high_fission_yield(
        fission_product_nuclide);
