...
use crate::endf_8_parent_independent_yields::u234::fast_energy::u234_fast_fission_yield;
use crate::endf_8_parent_independent_yields::u234::high_energy::u234_high_fission_yield;
use crate::endf_8_parent_independent_yields::u234::thermal_energy::u234_thermal_fission_yield;


/// note, thermal fission yield data not available,
/// if at thermal fission spectrum, will give zero yield
pub (crate) fn linear_linear_energy_interpolation_u234(
    ...
    if neutron_energy == thermal_neutron_energy {
        ...
        return u234_thermal_fission_yield(fission_product_nuclide);

    } else if neutron_energy == fast_neutron_energy {
        // fast energy case
        return u234_fast_fission_yield(fission_product_nuclide);

    } else if neutron_energy == high_neutron_energy {
        // high energy case
        return u234_high_fission_yield(fission_product_nuclide);
    ...
    let high_fission_yield = u234_high_fission_yield(
        fission_product_nuclide);
