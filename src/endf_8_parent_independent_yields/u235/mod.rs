...
use crate::endf_8_parent_independent_yields::u235::fast_energy::u235_fast_fission_yield;
use crate::endf_8_parent_independent_yields::u235::high_energy::u235_high_fission_yield;
use crate::endf_8_parent_independent_yields::u235::thermal_energy::u235_thermal_fission_yield;


pub (crate) fn linear_linear_energy_interpolation_u235(
    ...
    if neutron_energy == thermal_neutron_energy {
        ...
        return u235_thermal_fission_yield(fission_product_nuclide);

    } else if neutron_energy == fast_neutron_energy {
        // fast energy case
        return u235_fast_fission_yield(fission_product_nuclide);

    } else if neutron_energy == high_neutron_energy {
        // high energy case
        return u235_high_fission_yield(fission_product_nuclide);
    ...
    let high_fission_yield = u235_high_fission_yield(
        fission_product_nuclide);
