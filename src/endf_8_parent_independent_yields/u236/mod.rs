...
use crate::endf_8_parent_independent_yields::u236::fast_energy::u236_fast_fission_yield;
use crate::endf_8_parent_independent_yields::u236::high_energy::u236_high_fission_yield;
use crate::endf_8_parent_independent_yields::u236::thermal_energy::u236_thermal_fission_yield;


/// note, thermal fission yield data not available,
/// if at thermal fission spectrum, will give zero yield
pub (crate) fn linear_linear_energy_interpolation_u236(
    ...
    if neutron_energy == thermal_neutron_energy {
        ...
        return u236_thermal_fission_yield(fission_product_nuclide);

    } else if neutron_energy == fast_neutron_energy {
        // fast energy case
        return u236_fast_fission_yield(fission_product_nuclide);

    } else if neutron_energy == high_neutron_energy {
        // high energy case
        return u236_high_fission_yield(fission_product_nuclide);
    ...
    let high_fission_yield = u236_high_fission_yield(
        fission_product_nuclide);
